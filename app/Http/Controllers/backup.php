...
if ($result2->num_rows > 0) {
  ...
  while ($row = $result2->fetch_assoc()) {
    ...
    $Pre_filename = substr($Pre_filename, 0, 8);
  }
} else {
  echo "0 results";
}
...
$Pre_filename = $fileName . $ex;
$path = '';
$filepath = [];
// $fileName ='D20200504.xls';
$mydir = 'D:\Office\Task Excels\Kothari\dcs dATA';   //Sourse Directory
...
$filepath = $mydir . DIRECTORY_SEPARATOR . $path;
